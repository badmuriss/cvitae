  ...
  "pt-BR": {
    ...
    projects: {
      ...
      list: {
        ...
        "64ers": {
          description: "Aplicação Vue.js simples para codificar arquivos em Base64 e decodificar strings Base64 de volta para arquivos baixáveis com detecção automática de mime."
        }
      }
    },
    contact: {
